...
test('parse', function (assert) {
    var tests: Array<string | Array<string>> = 'januar jan._februar feb._mars mars_april april_mai mai_juni juni_juli juli_august aug._september sep._oktober okt._november nov._desember des.'.split('_'),
        i;
