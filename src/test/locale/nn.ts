...
test('parse', function (assert) {
    var tests: Array<string | Array<string>> = 'januar jan_februar feb_mars mar_april apr_mai mai_juni jun_juli jul_august aug_september sep_oktober okt_november nov_desember des'.split('_'), i;
