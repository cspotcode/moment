...
test('parse', function (assert) {
    var tests: Array<string | Array<string>> = 'januari jan._februari feb._maart mrt._april apr._mei mei._juni jun._juli jul._augustus aug._september sep._oktober okt._november nov._december dec.'.split('_'), i;
