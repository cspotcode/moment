...
test('parse', function (assert) {
    var tests: Array<string | Array<string>> = 'januar jan._februar feb._marec mar._april apr._maj maj_junij jun._julij jul._avgust avg._september sep._oktober okt._november nov._december dec.'.split('_'), i;
